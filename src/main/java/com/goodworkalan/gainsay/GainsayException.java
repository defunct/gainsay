...
/**
 * A general purpose exception class that indicates that an error occurred in
 * one of the classes in the gainsay package.
 * 
 * @author Alan Gutierrez
 */
public class GainsayException
extends RuntimeException
{
     ...
     *            The error code.
     */
    public GainsayException(int code)
    {
        this.code = code;
    }
     ...
     *            The cause exception.
     */
    public GainsayException(int code, Throwable cause)
    {
        super(cause);
        this.code = code;
    }
     ...
     */
    public GainsayException add(Object argument)
    {
